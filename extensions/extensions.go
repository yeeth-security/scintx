...
//
// Each subdirectory (providers/, policies/, registries/) contains extension
// packages that auto-register via init(). The all/ subdirectories are
// auto-generated aggregation packages that import every extension so their
// init() functions run.
//
